...
* Рекурсивные функции на верхнем уровне (в компиляторе называется structure_item). С учетом каррирования
  * First-class Функции, в том числе с замыканиями, частичным примерением и взаимной рекурсией.
...
Для этой задачи выбирайте имя директории в виде ``[D]Фамилии'' латиницей.
